...
<p style="float: left;  text-align: center; width: 45%; margin-right: 1%; margin-bottom: 0.5em;"><img src="media_2021/T1_example.png" style="width: 100%">Source (contrast-enhanced T1)</p>
<p style="float: right;  text-align: center; width: 45%; margin-right: 1%; margin-bottom: 0.5em;"><img src="media_2021/T2_example.png" style="width: 100%">Target (high resolution T2)</p>
